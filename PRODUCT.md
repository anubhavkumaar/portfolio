...
- **Console facts:** age 25, Hyderabad, phone number and LinkedIn are answerable through the landing console, from the sheet. Hadoop, Hive, Oracle SQL Developer, UiPath and Power BI stay out of the headline skill set (an "also worked with" line).
